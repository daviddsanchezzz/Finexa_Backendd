export type WorldContinent = "europe" | "africa" | "asia" | "north_america" | "south_america" | "oceania";
...
const NORTH_AMERICA: string[] = ["AG","BS","BB","BZ","CA","CR","CU","DM","DO","SV","GD","GT","HT","HN","JM","MX","NI","PA","KN","LC","VC","TT","US"];
const SOUTH_AMERICA: string[] = ["AR","BO","BR","CL","CO","EC","GY","PY","PE","SR","UY","VE"];
const OCEANIA: string[] = ["AU","FJ","KI","MH","FM","NR","NZ","PW","PG","WS","SB","TO","TV","VU"];

export const CONTINENT_ORDER: WorldContinent[] = ["europe", "asia", "north_america", "south_america", "africa", "oceania"];
...
export const COUNTRIES: WorldCountry[] = [
  ...
  ...NORTH_AMERICA.map((code) => ({ code, continent: "north_america" as const })),
  ...SOUTH_AMERICA.map((code) => ({ code, continent: "south_america" as const })),
